...
while [ $(jack_lsp | grep -e "system:capture_1" -e "rakarrack:in_1" -e "rakarrack:in_2" -e "rakarrack:out_1" -e "system:playback_1" -e "rakarrack:out_2" -e "system:playback_2" -e "sooperlooper:common_in_1" -e "sooperlooper:common_in_2" -e "sooperlooper:common_out_1" -e "sooperlooper:common_out_2" -e "Hydrogen:out_L" -e "Hydrogen:out_R" -e "amsynth:L out" -e "amsynth:R out" -e "fluidsynth:left" -e "fluidsynth:right" | wc -l) != 17 ]
do
...
jack_connect "fluidsynth:left" sooperlooper:common_in_1
jack_connect "fluidsynth:right" sooperlooper:common_in_2
